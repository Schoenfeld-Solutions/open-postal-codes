...
- public D-A-CH data files, metadata values, state completeness, applicable record floors, unique post-code floors, sentinel rows, and tracked PBF files are checked
